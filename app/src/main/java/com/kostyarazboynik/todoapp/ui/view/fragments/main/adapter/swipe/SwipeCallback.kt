...
import com.kostyarazboynik.todoapp.ui.view.fragments.main.adapter.ToDoItemViewHolder
...
class SwipeCallback(
    ...
    private fun setDeleteCallback(viewHolder: RecyclerView.ViewHolder) =
        (viewHolder as? ToDoItemViewHolder)?.todoItem?.let { swipeCallback.onDelete(it) }
